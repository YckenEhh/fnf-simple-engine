...
class CharacterEditor extends FlxState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.DOWN || FlxG.keys.justPressed.S || FlxG.keys.justPressed.W || FlxG.keys.justPressed.UP)
		{
		...
		var rightP = FlxG.keys.anyJustPressed([RIGHT, D]);
		var downP = FlxG.keys.anyJustPressed([DOWN, S]);
		var leftP = FlxG.keys.anyJustPressed([LEFT, A]);
